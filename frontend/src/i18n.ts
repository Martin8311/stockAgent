...
export const messages = {
  en: {
    ...
    overview: {
      ...
      businessSubtitle: "Key portfolio signals, suitability context, and AI readiness",
      adminTitle: "Operations overview",
      adminSubtitle: "Governance workload, platform readiness, and controlled execution status",
      marketValueHint: "Calculated from current portfolio valuation flow",
      transactionsTracked: "transactions tracked",
      profileCompletion: "Profile completion",
      profileReady: "Suitability context is complete.",
      profileNeedsContext: "Add risk preference, horizon, and capital purpose before personalized analysis.",
      largestHolding: "Largest holding",
      ofPortfolio: "of portfolio",
      riskWatch: "Risk watch",
      aiReadiness: "AI readiness",
      aiReady: "Selected model is available for governed analysis.",
      aiModelMissing: "No model selected yet.",
      recentAnalysis: "Recent analysis",
      pendingApprovals: "Pending approvals",
      pendingApprovalsHint: "Human decisions waiting in the governance queue",
      sandboxQueue: "Sandbox queue",
      sandboxTasksTracked: "sandbox tasks tracked",
      modelAvailability: "Model availability",
      enabledModels: "enabled models",
      activeSkills: "Active skills",
      skillsManaged: "skills managed",
      platformHealth: "Platform health",
      complianceGuardOn: "Compliance guard is enabled.",
      complianceGuardUnknown: "Compliance guard status is unavailable.",
      sandboxAttention: "Sandbox attention",
      sandboxNeedsReview: "Some tasks failed, were rejected, or need approval.",
      sandboxStable: "No sandbox task currently needs attention.",
      providerReadiness: "Market data providers",
      providerReadinessHint: "Enabled providers available for quote and valuation workflows",
      skillVersionFlow: "Skill version flow",
      skillVersionFlowHint: "Pending approval / draft or tested versions"
    },
    hero: {
  ...
  zh: {
    ...
    overview: {
      businessTitle: "业务概览",
      businessSubtitle: "核心持仓信号、适当性上下文和 AI 可用状态",
      adminTitle: "后台运营概览",
      adminSubtitle: "治理工作量、平台就绪度和受控执行状态",
      marketValueHint: "基于当前组合估值流程计算",
      transactionsTracked: "条交易记录",
      profileCompletion: "画像完整度",
      profileReady: "适当性上下文已完整。",
      profileNeedsContext: "补充风险偏好、投资期限和资金用途后再做个性化分析。",
      largestHolding: "最大持仓",
      ofPortfolio: "组合占比",
      riskWatch: "风险关注",
      aiReadiness: "AI 可用状态",
      aiReady: "当前模型可用于受控分析。",
      aiModelMissing: "尚未选择模型。",
      recentAnalysis: "最近分析",
      pendingApprovals: "待审批",
      pendingApprovalsHint: "治理队列中等待人工决策的请求",
      sandboxQueue: "Sandbox 队列",
      sandboxTasksTracked: "条 Sandbox 任务",
      modelAvailability: "模型可用性",
      enabledModels: "个模型已启用",
      activeSkills: "生效 Skill",
      skillsManaged: "个 Skill 纳入管理",
      platformHealth: "平台健康",
      complianceGuardOn: "合规守卫已启用。",
      complianceGuardUnknown: "合规守卫状态暂不可用。",
      sandboxAttention: "Sandbox 关注项",
      sandboxNeedsReview: "存在失败、拒绝或待审批任务。",
      sandboxStable: "当前没有需要关注的 Sandbox 任务。",
      providerReadiness: "行情数据源",
      providerReadinessHint: "可用于行情查询和组合估值流程的已启用数据源",
      skillVersionFlow: "Skill 版本流",
      skillVersionFlowHint: "待审批 / 草稿或已测试版本"
    },
    hero: {
